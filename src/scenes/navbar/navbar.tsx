...
const isMediumScreens = useMediaQuery("(min-width: 1060px)");
const navbarBackground = isTopOfPage ? "" : "bg-pink2 drop-shadow";
  ...
  return (
    <nav>
      <div className={` ${navbarBackground} ${flexBetween} fixed top-0  z-30 w-full  py-6  `} >
        <div className={`${flexBetween} mx-auto  w-5/6 `} >
         <div className={`${flexBetween} w-full  gap-16`}>
           ...
           <button 
            className=" flex items-center justify-center h-7  w-7 rounded-full bg-blue"
      ...
      {/* Mobile  menu*/}
          ...
          {!isMediumScreens &&isMenuToggled &&(
            <div  className="fixed right-0 bottom-0 z-40 h-full w-[300px] bg-pink2 drop-shadow-xl ">
